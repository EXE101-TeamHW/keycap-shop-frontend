  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col fixed inset-y-0 z-50">
        <div className="h-16 flex items-center px-6 border-b border-gray-100 cursor-pointer" onClick={() => navigate("/admin")}>
          <div className="text-2xl font-black text-gray-900 tracking-tight">
            HWSHOP <span className="text-purple-600">ADMIN</span>
          </div>
        </div>
