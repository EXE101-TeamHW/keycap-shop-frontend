...
export const products: Product[] = [
  {
    ...
    popularity: 95,
    description:
      "Vibrant gradient keycaps with a dreamy neon aesthetic. Perfect for those who want their keyboard to stand out.",
    stock: 12,
    layout: "65%",
    profile: "Cherry",
    images: [
  ...
  },
  {
    ...
    popularity: 88,
    description:
      "RGB backlit compatible keycaps with a futuristic cyberpunk theme. Shine-through legends for maximum visibility.",
    stock: 8,
    layout: "TKL",
    profile: "OEM",
    images: [
  ...
  },
  {
    ...
    popularity: 92,
    description:
      "Clean and elegant white keycaps with subtle gray legends. Perfect for a professional workspace setup.",
    stock: 15,
    layout: "60%",
    profile: "DSA",
    images: [
  ...
  },
  {
    ...
    popularity: 85,
    description:
      "80s inspired retro wave design with pink and purple gradients. Nostalgic vibes meet modern quality.",
    stock: 20,
    layout: "75%",
    profile: "SA",
    images: [
  ...
  },
  {
    ...
    popularity: 78,
    description:
      "Deep ocean blue themed keycaps with wave-inspired designs. Calming aesthetic for focused work sessions.",
    stock: 10,
    layout: "FULL",
    profile: "Cherry",
    images: [
  ...
  },
  {
    ...
    popularity: 90,
    description:
      "Soft pink and white keycaps inspired by Japanese cherry blossoms. Delicate and beautiful design.",
    stock: 5,
    layout: "65%",
    profile: "MT3",
    images: [
  ...
  },
  {
    ...
    popularity: 87,
    description:
      "Premium carbon fiber texture keycaps with a matte black finish. Ultimate sophistication and durability.",
    stock: 7,
    layout: "TKL",
    profile: "XDA",
    images: [
  ...
  },
  {
    ...
    popularity: 82,
    description:
      "Warm sunset gradient from orange to purple. Brings warmth and creativity to your desk setup.",
    stock: 18,
    layout: "60%",
    profile: "OEM",
    images: [
