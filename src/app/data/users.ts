...
export class AuthService {
  ...
  private static notifyAuthChanged(user: User | null) {
    // Broadcast auth changes so UI can react (e.g., Navigation menu)
  ...
  static register(userData: Omit<User, "id" | "createdAt">): {
    success: boolean;
    user?: User;
    message?: string;
  } {
    ...
    this.notifyAuthChanged(newUser);
